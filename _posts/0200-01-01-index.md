...
{% comment %}
This image is pathed to include `mapbox.github.com` in order to accommodate scenarios where the page is viewed via `mbtiles.org`.
{% endcomment %}
<img src='http://mapbox.github.com{{site.baseurl}}/images/mbtiles.png' class='centered' style='float:right;' />
</div>
------
